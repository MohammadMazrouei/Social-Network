...
#include "ui_followings_posts.h"

Followings_posts::Followings_posts(QWidget *parent) :
	QWidget(parent),
	ui(new Ui::Followings_posts)
{
	ui->setupUi(this);
...
bool Followings_posts::check_like(int index)
{
...
void Followings_posts::list_users_liked()
{
...
void Followings_posts::like(int index)
{
...
void Followings_posts::unlike(int index)
{
...
void Followings_posts::show_posts()
{
	...
	QSqlQuery q;
	if(!q.exec("SELECT username FROM '"+table_name +"'; ")) {
...
void Followings_posts::show_posts2()
{
...
void Followings_posts::get_username()
{
...
void Followings_posts::on_btn_mypage_clicked()
{
...
void Followings_posts::on_btn_like1_clicked()
{
	int len = posts.length();
	if (len > 0) {
...
void Followings_posts::on_btn_like2_clicked()
{
	int len = posts.length();
	if (len > 1) {
...
void Followings_posts::on_btn_like3_clicked()
{
	int len = posts.length();
	if (len > 2) {
...
void Followings_posts::on_btn_like4_clicked()
{
	int len = posts.length();
	if (len > 3) {
...
void Followings_posts::on_btn_like5_clicked()
{
	int len = posts.length();
	if (len > 4) {
...
void Followings_posts::on_btn_like6_clicked()
{
	int len = posts.length();
	if (len > 5) {
...
void Followings_posts::on_btn_seepage1_clicked()
{
	int len = posts.length();
	if(len > 0) {
...
void Followings_posts::on_btn_seepage2_clicked()
{
	int len = posts.length();
	if(len > 1) {
...
void Followings_posts::on_btn_seepage3_clicked()
{
	int len = posts.length();
	if(len > 2) {
...
void Followings_posts::on_btn_seepage4_clicked()
{
	int len = posts.length();
	if(len > 3) {
...
void Followings_posts::on_btn_seepage5_clicked()
{
	int len = posts.length();
	if(len > 4) {
...
void Followings_posts::on_btn_seepage6_clicked()
{
	int len = posts.length();
	if(len > 5) {
...
void Followings_posts::on_btn_next_clicked()
{
	int len = posts.length();
...
void Followings_posts::on_btn_pervious_clicked()
{
